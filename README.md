...
<img width="903" height="727" alt="изображение" src="https://github.com/user-attachments/assets/0f03fcbe-736f-4fd8-ba7b-eb1a8ed9a77e" />
...
```python
    ...
    # 3. Добавьте в src/actions/__init__.py импорт нового класса действия
```
